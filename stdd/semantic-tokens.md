...
- `[REQ:ESCAPE_KEY_BEHAVIOR]` - Escape key closes modal widgets (help, menus, dialogs)
...
- `[ARCH:ESCAPE_TRANSLATION]` - Escape key translation architecture for modal widgets [REQ:ESCAPE_KEY_BEHAVIOR]
...
- `[IMPL:ESCAPE_TRANSLATION]` - Escape key translation to C-[ for modal exit [ARCH:ESCAPE_TRANSLATION] [REQ:ESCAPE_KEY_BEHAVIOR]
